				...
				<div className="grid md:grid-cols-2 gap-6">
					...
					<div className="bg-white rounded-xl p-6 shadow-md flex flex-col justify-between">
						<div>
							...
							<p className="text-gray-700 mb-4 text-sm">
								"Grew to{" "}
								<span className="font-bold text-orange-600">2,500+ members</span>{" "}
								and <span className="font-bold text-orange-600">$18,000+/mo</span>{" "}
					...
					<div className="bg-white rounded-xl p-6 shadow-md flex flex-col justify-between">
						<div>
							...
							<p className="text-gray-700 mb-4 text-sm">
								"Retention jumped to{" "}
								<span className="font-bold text-orange-600">92%</span>. Affiliate
								program brought in{" "}
								<span className="font-bold text-orange-600">$4,000+</span> last
								quarter."
							</p>
						</div>
						<a
